...
<!--<link href="vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">-->
  ...
  <body>
    ...
    <div class="container">
      ...
      <a href="subastas/index.php">Subastas</a>
          ...
          <form>
            <div class="form-row">
              <div class="col-12 col-md-9 mb-2 mb-md-0">
                <input type="email" class="form-control form-control-lg" placeholder="Busque su tiempo compartido...">
              </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
            ...
            <p class="lead mb-0">Usted podra adquirir propiedades a travez de subastas</p>
          </div>
        </div>
        <div class="col-lg-4">
...
>>>>>>> 11b635f9b387842ddde7390373849a957f90671a
        </div>
      </div>
    </div>
  </section>
